...
declare i8*     @weld_rt_dict_new(i32, i32 (i8*, i8*)*, i32, i64, i64)
declare i8*     @weld_rt_dict_lookup(i8*, i32, i8*)
declare void    @weld_rt_dict_put(i8*, i8*)
declare void    @weld_rt_dict_finalize_begn(i8*)
declare i8*     @weld_rt_dict_finalize_next(i8*)
declare i8*     @weld_rt_dict_finalize_get_global_slot(i8*, i8*)
declare i8*     @weld_rt_dict_new_kv_vector(i8*, i32, i32)
