...
; - DICTTY: The type variable of the dictionary. This is solely for the purpose of avoiding name collision.
;           when there are two different groupbuilders. TODO: Look for cleaner solution.
