...
lazy_static! {
    pub static ref OPTIMIZATION_PASSES: HashMap<&'static str, Pass> = {
        ...
        m.insert(
            "inline-apply",
            Pass::new(
                vec![Transformation::new(inliner::inline_apply)],
                "inline-apply",
            ),
        );
        m.insert(
        ...
        m.insert(
            "inline-zip",
            Pass::new(
                vec![Transformation::new(inliner::inline_zips)],
                "inline-zip",
            ),
        );
        m.insert(
        ...
        m.insert(
            "unroll-static-loop",
            Pass::new(
                vec![Transformation::new(unroller::unroll_static_loop)],
                "unroll-static-loop",
            ),
        );
        m.insert(
            "infer-size",
            Pass::new(
                vec![Transformation::new(size_inference::infer_size)],
                "infer-size",
            ),
        );
        m.insert(
            ...
            Pass::new(
                vec![
                    Transformation::new(inliner::inline_negate),
        ...
        m.insert(
            "unroll-structs",
            Pass::new(
                vec![Transformation::new(inliner::unroll_structs)],
                "unroll-structs",
            ),
        );
        m.insert(
            ...
            Pass::new(
                vec![Transformation::new(short_circuit::short_circuit_booleans)],
                "short-circuit-booleans",
            ),
        );
        m.insert(
        ...
        m.insert(
            "vectorize",
            Pass::new(
                vec![Transformation::new(vectorizer::vectorize)],
                "vectorize",
            ),
        );
        m.insert(
            "fix-iterate",
            Pass::new(
                vec![Transformation::new(annotator::force_iterate_parallel_fors)],
                "fix-iterate",
            ),
        );
        m
