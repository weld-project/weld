...
extern "C" {
    ...
    #[no_mangle]
    pub fn weld_rt_dict_new(key_size: int32_t, val_size: int32_t, to_array_true_val_size: int32_t,
    ...
    #[no_mangle]
    pub fn weld_rt_gb_new(key_size: int32_t, val_size: int32_t, max_local_bytes: int64_t,
