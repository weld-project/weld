...
@.strl = private unnamed_addr constant [15 x i8] c"longlenth %ld\0A\00", align 1
...
b.b1:
  ...
  ; Here, the loop continues, and the stack frame causes a crash!
  ; See the SIR for the exact semantics, but F3 is being called repeatedly
  ; (F3 is the iterate call) - we should add support for a For loop over a range
  ; so that we can generate code differently here.
...
define void @f6(%s4 %buffer1.in, i64 %fn3_tmp.13.in, %v3.bld %fn3_tmp.14.in, i32 %fn3_tmp.16.in, %v4.bld %fn3_tmp.17.in, %v4.bld %fn3_tmp.19.in, %v0.bld %fn5_tmp.in, %v2 %project.in, %work_t* %cur.work) {
fn.entry:
  %fn3_tmp.19 = alloca %v4.bld
  %fn3_tmp.16 = alloca i32
  %buffer1 = alloca %s4
  %fn3_tmp.17 = alloca %v4.bld
  %fn5_tmp = alloca %v0.bld
  %fn3_tmp.13 = alloca i64
  %project = alloca %v2
  %fn3_tmp.14 = alloca %v3.bld
  %fn6_tmp = alloca %s4
  %fn6_tmp.2 = alloca %s5
  %fn6_tmp.1 = alloca i1
  %fn6_tmp.3 = alloca %s5

  store %v4.bld %fn3_tmp.19.in, %v4.bld* %fn3_tmp.19
  store i32 %fn3_tmp.16.in, i32* %fn3_tmp.16
  store %s4 %buffer1.in, %s4* %buffer1
  store %v4.bld %fn3_tmp.17.in, %v4.bld* %fn3_tmp.17
  store %v0.bld %fn5_tmp.in, %v0.bld* %fn5_tmp
  store i64 %fn3_tmp.13.in, i64* %fn3_tmp.13
  store %v2 %project.in, %v2* %project
  store %v3.bld %fn3_tmp.14.in, %v3.bld* %fn3_tmp.14
  %cur.tid = call i32 @weld_rt_thread_id()
  br label %b.b0
b.b0:
  ...
  %t.t2 = load %v3.bld, %v3.bld* %fn3_tmp.14
...
define void @f5(%s4 %buffer1.in, i64 %fn3_tmp.13.in, %v3.bld %fn3_tmp.14.in, i32 %fn3_tmp.16.in, %v4.bld %fn3_tmp.17.in, %v4.bld %fn3_tmp.19.in, %v0.bld %fn3_tmp.22.in, %v2 %project.in, %work_t* %cur.work) {
fn.entry:
  %buffer1 = alloca %s4
  %project = alloca %v2
  %fn3_tmp.14 = alloca %v3.bld
...
b.b0:
  ...
  %t.t3 = load %v3.bld, %v3.bld* %fn3_tmp.14
  %t.t4 = load i32, i32* %fn3_tmp.16
  %t.t5 = load %v4.bld, %v4.bld* %fn3_tmp.17
  %t.t6 = load %v4.bld, %v4.bld* %fn3_tmp.19
...
define void @f4_wrapper(%s4 %buffer1, i64 %fn3_tmp.13, %v3.bld %fn3_tmp.14, i32 %fn3_tmp.16, %v4.bld %fn3_tmp.17, %v4.bld %fn3_tmp.19, %v0.bld %fn3_tmp.22, %v0 %fn3_tmp.23, %v2 %project, %work_t* %cur.work) {
fn.entry:
...
for.ser:
  ...
  call void @f5(%s4 %buffer1, i64 %fn3_tmp.13, %v3.bld %fn3_tmp.14, i32 %fn3_tmp.16, %v4.bld %fn3_tmp.17, %v4.bld %fn3_tmp.19, %v0.bld %fn3_tmp.22, %v2 %project, %work_t* %cur.work)
  br label %fn.end
for.par:
  ...
  %t.t17 = insertvalue %s11 %t.t16, %v3.bld %fn3_tmp.14, 2
  %t.t18 = insertvalue %s11 %t.t17, i32 %fn3_tmp.16, 3
  %t.t19 = insertvalue %s11 %t.t18, %v4.bld %fn3_tmp.17, 4
  %t.t20 = insertvalue %s11 %t.t19, %v4.bld %fn3_tmp.19, 5
...
entry:
  ...
  br i1 %t.t6, label %new_pieces, label %fn_call
new_pieces:
  call void @v3.bld.newPiece(%v3.bld %fn3_tmp.14, %work_t* %cur.work)
  call void @v4.bld.newPiece(%v4.bld %fn3_tmp.17, %work_t* %cur.work)
  call void @v4.bld.newPiece(%v4.bld %fn3_tmp.19, %work_t* %cur.work)
  call void @v0.bld.newPiece(%v0.bld %fn3_tmp.22, %work_t* %cur.work)
  br label %fn_call
fn_call:
  call void @f5(%s4 %buffer1, i64 %fn3_tmp.13, %v3.bld %fn3_tmp.14, i32 %fn3_tmp.16, %v4.bld %fn3_tmp.17, %v4.bld %fn3_tmp.19, %v0.bld %fn3_tmp.22, %v2 %project, %work_t* %cur.work)
...
b.b0:
  ...
  %callz = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.strl, i32 0, i32 0), i64 %t.t1)
...
b.b4:
  ...
  %t.t34 = load %v3.bld, %v3.bld* %t.t33
  store %v3.bld %t.t34, %v3.bld* %fn3_tmp.14
  ; merge(fn3_tmp#14, isNull)
  %t.t35 = load %v3.bld, %v3.bld* %fn3_tmp.14
  %t.t36 = load i1, i1* %isNull
  call %v3.bld @v3.bld.merge(%v3.bld %t.t35, i1 %t.t36, i32 %cur.tid)
  ...
  %t.t43 = load %v4.bld, %v4.bld* %t.t42
  store %v4.bld %t.t43, %v4.bld* %fn3_tmp.17
  ...
  %t.t46 = load %v4.bld, %v4.bld* %fn3_tmp.17
  %t.t47 = load i32, i32* %fn3_tmp.18
  call %v4.bld @v4.bld.merge(%v4.bld %t.t46, i32 %t.t47, i32 %cur.tid)
  ; fn3_tmp#19 = buffer1.$4
  %t.t48 = getelementptr inbounds %s4, %s4* %buffer1, i32 0, i32 4
  %t.t49 = load %v4.bld, %v4.bld* %t.t48
  store %v4.bld %t.t49, %v4.bld* %fn3_tmp.19
  ; merge(fn3_tmp#19, length)
  %t.t50 = load %v4.bld, %v4.bld* %fn3_tmp.19
  %t.t51 = load i32, i32* %length
  call %v4.bld @v4.bld.merge(%v4.bld %t.t50, i32 %t.t51, i32 %cur.tid)
  ; fn3_tmp#20 = false
...
b.b6:
  ...
  %t.t70 = load %v3.bld, %v3.bld* %fn3_tmp.14
  %t.t71 = load i32, i32* %fn3_tmp.16
  %t.t72 = load %v4.bld, %v4.bld* %fn3_tmp.17
  %t.t73 = load %v4.bld, %v4.bld* %fn3_tmp.19
  %t.t74 = load %v0.bld, %v0.bld* %fn3_tmp.22
  %t.t75 = load %v0, %v0* %fn3_tmp.23
  %t.t76 = load %v2, %v2* %project

  call void @f4_wrapper(%s4 %t.t68, i64 %t.t69, %v3.bld %t.t70, i32 %t.t71, %v4.bld %t.t72, %v4.bld %t.t73, %v0.bld %t.t74, %v0 %t.t75, %v2 %t.t76, %work_t* %cur.work)
  br label %body.end
b.b7:
  ...
  %t.t82 = load %v3.bld, %v3.bld* %fn3_tmp.14
  %t.t83 = load i32, i32* %fn3_tmp.16
  %t.t84 = load %v4.bld, %v4.bld* %fn3_tmp.17
  %t.t85 = load %v4.bld, %v4.bld* %fn3_tmp.19
  %t.t86 = load %v0.bld, %v0.bld* %fn5_tmp
  %t.t87 = load %v2, %v2* %project
  call void @f6(%s4 %t.t80, i64 %t.t81, %v3.bld %t.t82, i32 %t.t83, %v4.bld %t.t84, %v4.bld %t.t85, %v0.bld %t.t86, %v2 %t.t87, %work_t* %cur.work)
  br label %body.end
body.end:
  ret void
}
