...
class GrizzlyImpl(object):
    ...
    def mask(self, array, predicates, new_value, type):
        """
    ...
    def filter(self, array, predicates, type):
        """
        Returns a new array, with each element in the original array satisfying the
        passed-in predicate set to `new_value`
    ...
    def element_wise_op(self, array, other, op, type):
        """
    ...
    def compare(self, array, other, op, type_str):
        """
    ...
    def slice(self, array, start, size, type):
        """
    ...
    def groupby_sum(self, columns, column_types, grouping_column):
        """
    ...
    def get_column(self, columns, column_types, index):
        """
