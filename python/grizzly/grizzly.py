...
class SeriesWeld(LazyOpResult):
    ...
    def add(self, other):
        ...
        if isinstance(other, SeriesWeld):
            other = other.expr
        return SeriesWeld(
            grizzly_numpy_impl.element_wise_op(
                self.expr,
                other,
                "+",
                self.weld_type
